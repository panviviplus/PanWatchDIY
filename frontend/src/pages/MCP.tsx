...
export default function MCPPage() {
  ...
  "mcpServers": {
    "mindalpha": {
      "description": "PanWatchDIY 盯盘投资分析 MCP：支持自选股、持仓、K线、新闻、价格提醒、基金、AI Agent 等 40+ 工具",
      "type": "streamableHttp",
    ...
    <div className="space-y-6">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div>
            ...
            <p className="text-[13px] text-muted-foreground mt-1">
              PanWatchDIY 提供 40+ MCP 工具，覆盖自选股、持仓、K线、新闻、价格提醒、基金、AI Agent 等功能。
            </p>
          </div>
      ...
      <div className="card p-5">
        ...
        <div className="text-[12px] text-muted-foreground space-y-1">
          <p>当前 PanWatchDIY MCP 使用 <span className="font-medium text-foreground">JSON-RPC over HTTP</span>。</p>
